...
```
"Helena Quirino"     -> "Otávio Quadros"    (0.28)
"Marcelo Paulo Antunes" -> "Otávio Quadros"    (0.48)
"Anderson Vasques"  -> "Alderson Campos"   (0.55)
...
O custo do corte é perder apelidos: `"Bea Nogueira"` →
`"Beatriz Quirino Nogueira"` (0.69) é um acerto real que cai em revisão. Aceitável
...
"vinculo": {
  ...
  "detalhe": {
    "nome_buscado": "Helena Quirino",
    "melhor_candidato": "Otávio Quadros",
    "score": 0.28,
    "limiar": 0.90
  },
...
o quase-acerto. Ver `"Bea Nogueira" → "Beatriz Quirino Nogueira" (0.69)` repetido
...
Buscamos por         Helena Quirino
Melhor correspondência  Otávio Quadros
